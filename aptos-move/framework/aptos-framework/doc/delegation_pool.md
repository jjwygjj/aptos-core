...
<b>apply</b> <a href="delegation_pool.md#0x1_delegation_pool_Null_Shareholder_Addr_Requirement">Null_Shareholder_Addr_Requirement</a> <b>to</b>
withdraw, add_stake, unlock, reactivate_stake, synchronize_delegation_pool;
<b>apply</b> <a href="delegation_pool.md#0x1_delegation_pool_Global_Pending_Withdrawl_Owner">Global_Pending_Withdrawl_Owner</a> <b>to</b> *;
<b>apply</b> <a href="delegation_pool.md#0x1_delegation_pool_Total_Coin_Inactive_LE_Inactive_Stake_Pool">Total_Coin_Inactive_LE_Inactive_Stake_Pool</a> <b>to</b>
withdraw, add_stake, unlock, reactivate_stake, synchronize_delegation_pool;
<b>apply</b> <a href="delegation_pool.md#0x1_delegation_pool_Withdraw_Requirements">Withdraw_Requirements</a>  {
...
<a name="0x1_delegation_pool_Null_Shareholder_Addr_Requirement"></a>


<pre><code><b>schema</b> <a href="delegation_pool.md#0x1_delegation_pool_Null_Shareholder_Addr_Requirement">Null_Shareholder_Addr_Requirement</a> {
    pool_address: <b>address</b>;
...
<a name="0x1_delegation_pool_Pool_Delegator_Address_Not_Eq"></a>


<pre><code><b>schema</b> <a href="delegation_pool.md#0x1_delegation_pool_Pool_Delegator_Address_Not_Eq">Pool_Delegator_Address_Not_Eq</a> {
    pool_address: <b>address</b>;
    delegator_address: <b>address</b>;
...
<a name="0x1_delegation_pool_Global_Pending_Withdrawl_Owner"></a>


<pre><code><b>schema</b> <a href="delegation_pool.md#0x1_delegation_pool_Global_Pending_Withdrawl_Owner">Global_Pending_Withdrawl_Owner</a> {
...
<a name="0x1_delegation_pool_Total_Coin_Inactive_LE_Inactive_Stake_Pool"></a>


<pre><code><b>schema</b> <a href="delegation_pool.md#0x1_delegation_pool_Total_Coin_Inactive_LE_Inactive_Stake_Pool">Total_Coin_Inactive_LE_Inactive_Stake_Pool</a> {
    pool_address: <b>address</b>;
...
<a name="0x1_delegation_pool_Withdraw_Requirements"></a>


<pre><code><b>schema</b> <a href="delegation_pool.md#0x1_delegation_pool_Withdraw_Requirements">Withdraw_Requirements</a> {
...
<a name="0x1_delegation_pool_Redeem_Inactive"></a>


<pre><code><b>schema</b> <a href="delegation_pool.md#0x1_delegation_pool_Redeem_Inactive">Redeem_Inactive</a> {
    pool: <a href="delegation_pool.md#0x1_delegation_pool_DelegationPool">DelegationPool</a>;
    <b>ensures</b> <b>forall</b> i in 0..pool.observed_lockup_cycle.index:
        <a href="../../aptos-stdlib/doc/table.md#0x1_table_spec_contains">table::spec_contains</a>(pool.inactive_shares, <a href="delegation_pool.md#0x1_delegation_pool_ObservedLockupCycle">ObservedLockupCycle</a>{index: i}) ==&gt;
            <a href="../../aptos-stdlib/doc/table.md#0x1_table_spec_get">table::spec_get</a>(pool.inactive_shares, <a href="delegation_pool.md#0x1_delegation_pool_ObservedLockupCycle">ObservedLockupCycle</a>{index: i}).total_coins
                &lt;= <a href="../../aptos-stdlib/doc/table.md#0x1_table_spec_get">table::spec_get</a>(<b>old</b>(pool).inactive_shares, <a href="delegation_pool.md#0x1_delegation_pool_ObservedLockupCycle">ObservedLockupCycle</a>{index: i}).total_coins;
}
</code></pre>
...
<pre><code><b>pragma</b> verify = <b>false</b>;
<b>pragma</b> aborts_if_is_partial = <b>true</b>;
<b>include</b> <a href="delegation_pool.md#0x1_delegation_pool_Pool_Delegator_Address_Not_Eq">Pool_Delegator_Address_Not_Eq</a> {
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="delegation_pool.md#0x1_delegation_pool_DelegationPool">DelegationPool</a>&gt;(pool_address);
<b>requires</b> delegator_address != <a href="delegation_pool.md#0x1_delegation_pool_NULL_SHAREHOLDER">NULL_SHAREHOLDER</a>;
<b>let</b> pre_pool = <b>global</b>&lt;<a href="delegation_pool.md#0x1_delegation_pool_DelegationPool">DelegationPool</a>&gt;(pool_address);
<b>let</b> delegator_address = <a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(delegator);
<b>let</b> <b>post</b> pool = <b>global</b>&lt;<a href="delegation_pool.md#0x1_delegation_pool_DelegationPool">DelegationPool</a>&gt;(pool_address);
<b>let</b> pre_stake_pool = <a href="delegation_pool.md#0x1_delegation_pool_spec_get_stake">spec_get_stake</a>(pre_pool);
...
<b>include</b> <a href="delegation_pool.md#0x1_delegation_pool_Pool_Delegator_Address_Not_Eq">Pool_Delegator_Address_Not_Eq</a>;
<b>include</b> <a href="delegation_pool.md#0x1_delegation_pool_Withdraw_Requirements">Withdraw_Requirements</a>;
...
<b>let</b> <b>post</b> stake_pool = <a href="delegation_pool.md#0x1_delegation_pool_spec_get_stake">spec_get_stake</a>(pool);
<b>ensures</b> !(withdrawal_exists &&
    (withdrawal_olc.index &lt; <b>old</b>(pool).observed_lockup_cycle.index || <a href="delegation_pool.md#0x1_delegation_pool_spec_can_withdraw_pending_inactive">spec_can_withdraw_pending_inactive</a>(pool_address))) ==&gt;
    pre_stake_pool == stake_pool;
